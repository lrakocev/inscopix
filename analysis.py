...
avg_util = fin_df.groupby(['utility']).mean()
...
avg_rew_cost_1 = cost_1_df.groupby(['reward_level']).mean()
...
avg_rew_cost_3 = cost_3_df.groupby(['reward_level']).mean()
...
avg_cost = fin_df.groupby(['cost_level']).mean()
